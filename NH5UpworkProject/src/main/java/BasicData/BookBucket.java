...
public class BookBucket extends Base{
    ...
    By onePropertyClick = By.xpath("//a[text()='Grindon Primary Care Centre']");
	...
	public void onePropertyLinkImage() throws InterruptedException
	{
		Thread.sleep(4000);
		WebElement opcount=driver.findElement(onePropertyClick);
		opcount.click();
		List<WebElement> opimageCount = driver.findElements(onePropertyClick);
